    ...
    content: {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            { term: 'la familia', translations: { en: 'family', de: 'die Familie' }, example: 'Esta es mi familia.' },
            { term: 'el padre', translations: { en: 'father', de: 'der Vater' } },
            { term: 'la madre', translations: { en: 'mother', de: 'die Mutter' } },
            { term: 'los padres', translations: { en: 'parents', de: 'die Eltern' }, example: 'Estos son mis padres.' },
            { term: 'el hermano', translations: { en: 'brother', de: 'der Bruder' } },
            { term: 'la hermana', translations: { en: 'sister', de: 'die Schwester' } },
            { term: 'el hijo', translations: { en: 'son', de: 'der Sohn' } },
            { term: 'la hija', translations: { en: 'daughter', de: 'die Tochter' } },
            { term: 'el abuelo', translations: { en: 'grandfather', de: 'der Großvater' } },
            { term: 'la abuela', translations: { en: 'grandmother', de: 'die Großmutter' } },
            { term: 'el sobrino', translations: { en: 'nephew', de: 'der Neffe' } },
            { term: 'la sobrina', translations: { en: 'niece', de: 'die Nichte' } },
          ],
        },
        {
    ...
    content: {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            { term: 'alto / alta', translations: { en: 'tall (person)', de: 'groß (Person)' } },
            { term: 'bajo / baja', translations: { en: 'short (person)', de: 'klein (Person)' } },
            { term: 'delgado / delgada', translations: { en: 'slim', de: 'schlank' } },
            { term: 'moreno / morena', translations: { en: 'dark-haired', de: 'dunkelhaarig' } },
            { term: 'rubio / rubia', translations: { en: 'blond', de: 'blond' } },
            { term: 'simpático / simpática', translations: { en: 'nice, likeable', de: 'sympathisch' } },
            { term: 'serio / seria', translations: { en: 'serious', de: 'ernst' } },
            { term: 'divertido / divertida', translations: { en: 'funny', de: 'lustig' } },
            { term: 'inteligente', translations: { en: 'intelligent', de: 'intelligent' } },
            { term: 'joven', translations: { en: 'young', de: 'jung' } },
            { term: 'mayor', translations: { en: 'older, old (person)', de: 'älter, alt (Person)' } },
            { term: 'parecerse a', translations: { en: 'to resemble', de: 'ähneln' } },
          ],
        },
        {

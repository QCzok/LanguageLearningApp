    ...
    content: {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            { term: 'el libro', translation: 'das Buch', example: 'El libro está en la mesa.' },
            { term: 'la casa', translation: 'das Haus' },
            { term: 'el coche', translation: 'das Auto' },
            { term: 'la ciudad', translation: 'die Stadt' },
            { term: 'el problema', translation: 'das Problem' },
            { term: 'la mano', translation: 'die Hand' },
            { term: 'el día', translation: 'der Tag' },
            { term: 'la canción', translation: 'das Lied' },
            { term: 'el color', translation: 'die Farbe' },
            { term: 'la flor', translation: 'die Blume' },
          ],
        },
        {
          id: 'esg1-1-match',

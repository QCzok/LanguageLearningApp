    ...
    content: {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            { term: 'Guten Morgen', translations: { en: 'good morning' }, example: 'Guten Morgen, Frau Behrens!' },
            { term: 'Guten Tag', translations: { en: 'hello / good day' }, example: 'Guten Tag, Herr Okafor!' },
            { term: 'Guten Abend', translations: { en: 'good evening' } },
            { term: 'Hallo', translations: { en: 'hi / hello' }, example: 'Hallo, Jonas!' },
            { term: 'Auf Wiedersehen', translations: { en: 'goodbye (formal)' } },
            { term: 'Tschüss', translations: { en: 'bye (informal)' } },
            { term: 'Bis später', translations: { en: 'see you later' } },
            { term: 'Wie geht es Ihnen?', translations: { en: 'how are you? (formal)' } },
            { term: 'Wie geht’s?', translations: { en: 'how are you? (informal)' } },
            { term: 'danke', translations: { en: 'thank you' } },
          ],
        },
        {
          id: 'a1-match',
    ...
    content: {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            { term: 'heißen', translations: { en: 'to be called' }, example: 'Ich heiße Samir.' },
            { term: 'der Name', translations: { en: 'name' }, article: 'der', plural: 'die Namen', example: 'Mein Name ist Elif.' },
            { term: 'Freut mich.', translations: { en: 'nice to meet you' } },
            { term: 'buchstabieren', translations: { en: 'to spell' } },
            { term: 'wer', translations: { en: 'who' } },
            { term: 'wie', translations: { en: 'how' } },
            { term: 'woher', translations: { en: 'where from' } },
            { term: 'wo', translations: { en: 'where' } },
          ],
        },
        {
    ...
    content: {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            { term: 'Deutschland', translations: { en: 'Germany' }, example: 'Ich wohne in Deutschland.' },
            { term: 'Österreich', translations: { en: 'Austria' } },
            { term: 'die Schweiz', translations: { en: 'Switzerland' }, article: 'die' },
            { term: 'die Türkei', translations: { en: 'Turkey' }, article: 'die' },
            { term: 'Polen', translations: { en: 'Poland' } },
            { term: 'Brasilien', translations: { en: 'Brazil' } },
            { term: 'die Ukraine', translations: { en: 'Ukraine' }, article: 'die' },
            { term: 'wohnen', translations: { en: 'to live / reside' }, example: 'Ich wohne in Leipzig.' },
            { term: 'kommen', translations: { en: 'to come' }, example: 'Ich komme aus Polen.' },
            { term: 'die Sprache', translations: { en: 'language' }, article: 'die', plural: 'die Sprachen' },
          ],
        },
        {
          id: 'a3-match-land',

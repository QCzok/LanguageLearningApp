    ...
    content: {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            { term: 'la calle', translations: { en: 'street', de: 'die Straße' } },
            { term: 'la plaza', translations: { en: 'square', de: 'der Platz' } },
            { term: 'la esquina', translations: { en: 'corner', de: 'die Ecke' } },
            { term: 'el banco', translations: { en: 'bank', de: 'die Bank' } },
            { term: 'la farmacia', translations: { en: 'pharmacy', de: 'die Apotheke' } },
            { term: 'el supermercado', translations: { en: 'supermarket', de: 'der Supermarkt' } },
            { term: 'la estación', translations: { en: 'train station', de: 'der Bahnhof' } },
            { term: 'la parada de autobús', translations: { en: 'bus stop', de: 'die Bushaltestelle' } },
            { term: 'el hospital', translations: { en: 'hospital', de: 'das Krankenhaus' } },
            { term: 'el museo', translations: { en: 'museum', de: 'das Museum' } },
            { term: 'la iglesia', translations: { en: 'church', de: 'die Kirche' } },
            { term: 'el parque', translations: { en: 'park', de: 'der Park' } },
          ],
        },
        {
          id: 'es3-p1-info-hay',
